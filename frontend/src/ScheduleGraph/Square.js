                ...
                <div class="below-player">
                    {viewType === "edit" ? 
                        ...
                        <div class="group">
                            ...
                            <div class="name" id="unit[pos3]d">{detail[1].player1[0].username}</div><div class="name" id="name[pos3]d">{detail[1].player1[1].username}</div>
                        </div>
                    }
                    <div class="separater"></div>
                    {viewType === "edit" ? 
                        ...
                        <div class="group">
                            ...
                            <div class="name" id="name[pos4]u">{getDepartmentLabel(detail[1].player2[1].departmentId)}{DEGREECODE[Number(detail[1].player2[1].degreeId)-1]}</div><br></br>
                            <div class="name" id="unit[pos4]d">{detail[1].player2[0].username}</div><div class="name" id="name[pos4]d">{detail[1].player2[1].username}</div>
                        </div>
                    }
                </div>
            </div>
